...
export default function Navbar() {
  ...
  return (
    <div className="w-full h-[60px] absolute top-0 left-0 right-0 shadow-lg z-50 min-h-10 bg-[#ffffff16] backdrop-blur-sm">
      ...
      {/* Mobile Menu */}
      <div 
        className={`fixed top-0 right-0 h-full w-80 bg-[#171e3d] shadow-2xl z-50 transform transition-transform duration-300 ease-in-out md:hidden ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-6 py-8 bg-white w-full h-full">
            <ul className="space-y-6">
              ...
              <li className="pt-4">
                <Link 
                  className="block w-full bg-blue-400 text-[#171e3d] text-center rounded-full px-6 py-3 font-semibold hover:bg-blue-500 transition-colors duration-300"
                  href="/"
                  onClick={closeMobileMenu}
                >
                  Contact
